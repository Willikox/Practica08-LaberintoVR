...
public class Door : MonoBehaviour {
    ...
    void Start () {
        ...
        leftDoorStartRotation = Quaternion.Euler(270, 0, 360);
        leftDoorEndRotation = leftDoorStartRotation * Quaternion.Euler(0f, 0f, 0f);
        rightDoorStartRotation = Quaternion.Euler(270, 0, 360);
        rightDoorEndRotation = rightDoorStartRotation * Quaternion.Euler(0f, 0f, 0f);
	...
	public void OnDoorClicked () {
        ...
        if (locked == false)
        {
            audioSource.clip = puertaAbierta;
        ...
        {
            audioSource.clip = puertaCerrada;
